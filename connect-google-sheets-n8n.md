# Dircetly Signing without CLient id & Client Secret
1. First Open n8n
2. Next to the Create Workflow there is '\/' click that and click the Create Credential
   
   <img width="700" height="250" alt="image" src="https://github.com/user-attachments/assets/f379a94f-7729-439a-8a1d-6413bd370f55" />

3. Search Google Sheets and pick Google Sheets OAuth2 API
   
   <img width="700" height="416" alt="image" src="https://github.com/user-attachments/assets/6e6db98b-4fbe-4218-8499-259a160cf3de" />
   
4. Click Continue
   
   <img width="700" height="339" alt="image" src="https://github.com/user-attachments/assets/f9ee81a0-7ef1-45a9-a36c-4438e51d0306" />

5. Click Sign in with Google

   <img width="700" height="448" alt="image" src="https://github.com/user-attachments/assets/900ecc77-735b-4c9f-9a10-8cc47dbb6c85" />

6. Then Sign in with your chosen email, and you're DONE :)
   

# Signing With Client Id and Client Secret
1. First Open n8n
2. Next to the Create Workflow there is '\/' click that and click the Create Credential
...
6. Click Google Cloud (if you never had an account before)

   <img width="700" height="832" alt="image" src="https://github.com/user-attachments/assets/8b37375d-6bc4-4fd2-af01-3cf5fa2a9c53" />

7. Scroll down till you find Google Cloud Console and click that
...
14. Choose API & Services and Click Library

    <img width="700" height="472" alt="image" src="https://github.com/user-attachments/assets/feefdb0b-862b-4ea5-b770-261e89359a1c" />

15. Search Gmail API, Google Drive API, Google Docs API, Google Sheets API, Google Slides API and don't forget to enable them all
    ...
    <img width="700" height="284" alt="image" src="https://github.com/user-attachments/assets/50805af5-a7a0-40f3-a8e1-480cd19f3b2a" />
    <img width="700" height="299" alt="image" src="https://github.com/user-attachments/assets/94bf2889-59b4-4bc8-b805-8393d32c9035" />
    <img width="700" height="281" alt="image" src="https://github.com/user-attachments/assets/48023e85-61fb-42ab-a0fb-3e8faaf5c063" />
    <img width="700" height="287" alt="image" src="https://github.com/user-attachments/assets/0dcd411f-ab12-40b8-9ee8-40988578d108" />

16. Click the GoogleCloud logo to go back and then Click on the Navigation Menu

    <img width="700" height="400" alt="image" src="https://github.com/user-attachments/assets/002b9532-c5a4-4ca4-a017-05c418cb7f32" />

17. Choose API & Services and Click OAuth consent screen
...
19. Fill in the Project Configuration
...
20. If you are not using local host, Go to Branding and click + Add domain

    <img width="700" height="748" alt="image" src="https://github.com/user-attachments/assets/261ec7fd-12eb-4dde-871e-8d8d845bf924" />

    a) Copy the domain
    
    <img width="700" height="375" alt="image" src="https://github.com/user-attachments/assets/c7ab1930-761e-483d-bbf3-658c373826a8" />

    b) Paste the domain
    
    <img width="700" height="686" alt="image" src="https://github.com/user-attachments/assets/c510e2c4-cb55-4cf0-bc3c-8aa08ecdb057" />

    c) Save

    <img width="700" height="456" alt="image" src="https://github.com/user-attachments/assets/812ed55d-edc2-4bd0-b659-98461e6279f0" />

21. Click the GoogleCloud logo to go back and then Click on the Navigation Menu

    <img width="700" height="400" alt="image" src="https://github.com/user-attachments/assets/002b9532-c5a4-4ca4-a017-05c418cb7f32" />
    
22. Choose API & Services and Click Credentials

    <img width="700" height="392" alt="image" src="https://github.com/user-attachments/assets/758f884e-f7d8-431c-b2d9-a05238eac62e" />

23. Click + Create credentials and then click OAuth client ID
