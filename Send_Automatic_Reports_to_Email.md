...
<h3>This workflow automatically sends a daily report via email every day at 5:00 PM, helping you stay updated without manual effort.</h3>
...
13. Click Google Cloud (if you never had an account before)

    <img width="700" height="832" alt="image" src="https://github.com/user-attachments/assets/8b37375d-6bc4-4fd2-af01-3cf5fa2a9c53" />

14. Scroll down till you find Google Cloud Console and click that
...
23. Click the GoogleCloud logo to go back and then Click on the Navigation Menu

    <img width="700" height="400" alt="image" src="https://github.com/user-attachments/assets/002b9532-c5a4-4ca4-a017-05c418cb7f32" />

24. Choose API & Services and Click OAuth consent screen
...
26. Fill in the Project Configuration
...
38. This Step Haven't Connect with the cloud yet, to connect that check this github in step 35
...
48. Fill in like this below
    ...
    c) For the value fill in with this
       <pre>
          {{ $now.setZone('Asia/Taipei').toFormat('yyyy-MM-dd') }}
      </pre>
   
       <img width="700" height="1282" alt="image" src="https://github.com/user-attachments/assets/6363af08-28d6-49a7-a3fb-a37fcf14a2e9" />
       *For the timezone, you can change based on your location :)


49. Click Settings Enable Always Output Data and Execute Step
    
    <img width="700" height="1341" alt="image" src="https://github.com/user-attachments/assets/ce0dbf6e-d7fd-4e11-8486-1242489c36e5" />

    It will appear like this in the output
    <img width="700" height="1379" alt="image" src="https://github.com/user-attachments/assets/a1cfb162-47c6-46f2-a540-bf073e4b2852" />

50. Click the +

    <img width="700" height="476" alt="image" src="https://github.com/user-attachments/assets/6729241f-05c7-4de8-aa1e-459e4b4c5cb8" />

51. Search set and Click Edit Fields (Set)

    <img width="700" height="1002" alt="image" src="https://github.com/user-attachments/assets/61145875-1337-437a-bb50-f29dfa6ee5d7" />

52. Change Mode to JSON, Fill the JSON like below
    <pre>
       {
        "report_message": "Daily Report\n\nDate: {{ $json['Date'] }}\nContent: {{ $json['Content'] }}\nStatus: {{ $json['Status'] }}\nNotes: {{ $json['Notes'] }}\n\nThis report is sent automatically by n8n."
       }
    </pre>
    
53. Click Settings, Enable Always Output Data and Execute step

    <img width="700" height="1319" alt="image" src="https://github.com/user-attachments/assets/0d62e5b5-9f33-46fe-add1-8b6abe861477" />

    It should appear like this

    <img width="700" height="1375" alt="image" src="https://github.com/user-attachments/assets/f78fcbb8-e358-403b-8730-7e83651e09a4" />

54. Click the +

    <img width="700" height="596" alt="image" src="https://github.com/user-attachments/assets/bdc4d5a5-b1ce-4c66-b92c-45bdc6c331fd" />

55. Search Brevo and the click Brevo

    <img width="700" height="1446" alt="image" src="https://github.com/user-attachments/assets/11334967-361c-428a-aa36-8a23c0c1c182" />

56. Scroll down, and click Send a transaction email

    <img width="700" height="1440" alt="image" src="https://github.com/user-attachments/assets/3b3672c4-72be-40f8-9718-ec494d91872f" />

57. Fill the Parameters like below
    
    For the Text Content, Just Drag from the input to Text Content
    For Sender, must use the same email you use in Brevo account

    <img width="700" height="1374" alt="image" src="https://github.com/user-attachments/assets/e00b5d60-d2cd-4b4f-9edb-bc75e0842383" />



58. Click Settings, Enable Always Output Data and Execute step

    <img width="700" height="1308" alt="image" src="https://github.com/user-attachments/assets/1710c00b-d94b-450d-b0b3-1f04798ade3d" />

    It should appear like this

    <img width="700" height="1358" alt="image" src="https://github.com/user-attachments/assets/4d537f26-30a6-4d41-a777-67605233377a" />

59. Click the +

    <img width="700" height="444" alt="image" src="https://github.com/user-attachments/assets/8a646921-4177-42ee-a2d8-0861f073adff" />

60. Search Brevo and the click Brevo

    <img width="700" height="1072" alt="image" src="https://github.com/user-attachments/assets/942fe17c-7bfb-47cc-80cd-0bb8bfeb81eb" />

61. Scroll down, and click Send a transaction emai

    <img width="700" height="1296" alt="image" src="https://github.com/user-attachments/assets/ff55d11f-355c-4462-8fc4-47482fbf5cfe" />

62. Fill the Parameters like below
    This is to notify us that the email has been sent successfully.
    For Sender, must use the same email you use in Brevo account

   <img width="700" height="1272" alt="image" src="https://github.com/user-attachments/assets/48b5d833-08f7-43be-88bb-95e2e52a61c0" />

63. Click Settings, Enable Always Output Data and Execute step

    <img width="700" height="1308" alt="image" src="https://github.com/user-attachments/assets/1710c00b-d94b-450d-b0b3-1f04798ade3d" />

    It should appear like this

    <img width="700" height="1019" alt="image" src="https://github.com/user-attachments/assets/617c2f02-ab28-4905-bedd-2985900cd176" />

    
64. Click Execute workflow

    <img width="700" height="1443" alt="image" src="https://github.com/user-attachments/assets/62a9883b-5ee9-410d-93ac-abc6550e189e" />


65. Result should be like this

    a) Send the Daily Report to Other email
    <img width="700" height="1403" alt="image" src="https://github.com/user-attachments/assets/23172136-b33f-4a7b-8a7b-a5caaba3e58f" />

    b) Receive to our own email that the email has been sent successfully
    <img width="700" height="1151" alt="image" src="https://github.com/user-attachments/assets/7a855468-668a-46df-9ac6-a1447fb8a54f" />
